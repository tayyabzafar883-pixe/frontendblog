...
const BlogCreation = () => {
  ...
  let update = async () => {
    try {
      let resp = await fetch(' https://blog-backend-6kdu.vercel.app/api/post/update', {
        method: 'PUT',
        credentials: 'include',
  ...
  let img = async (e) => {
    try {
      ...
      let resp = await fetch(' https://blog-backend-6kdu.vercel.app/api/post/createImg', {
        method: "POST",
        credentials: 'include',
        body: formData
      });
  ...
  let publish = async () => {
    ...
    try {
      let resp = await fetch(` https://blog-backend-6kdu.vercel.app/api/post/createpost`, {
        method: "POST",
        credentials: "include",
        headers: { "content-type": "application/json" },
